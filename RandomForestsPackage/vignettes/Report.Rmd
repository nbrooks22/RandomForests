...
#### `tree_list`
Eine Liste von Environments, so wie sie von z.b. `greedy_cart()`, `bagging()` oder ähnlichem generiert werden. 
ACHTUNG: Muss im List() format übergeben werden, auch wenn es nur ein Baum hat
```{r}
